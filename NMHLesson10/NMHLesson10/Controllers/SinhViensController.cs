...
namespace NMHLesson10.Controllers
{
    public class SinhViensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaSV,HoSV,TenSV,Phai,NgaySinh,NoiSinh,MaKH,HocBong,DiemTrungBinh")] SinhVien sinhVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult NmhEdit([Bind(Include = "MaSV,HoSV,TenSV,Phai,NgaySinh,NoiSinh,MaKH,HocBong,DiemTrungBinh")] SinhVien sinhVien)
        {
            if (ModelState.IsValid)
            {
